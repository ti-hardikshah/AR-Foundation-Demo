...
public class ARUXAnimationManager : MonoBehaviour
{
    ...
    [SerializeField] private GameObject FindImage, FindBody, FindFace, FindPlane, FindObject, TapToPlane;
    ...
    public void HideAllAnimation()
    {
        ...
        FindBody.SetActive(false);
        FindFace.SetActive(false);
        FindPlane.SetActive(false);
        FindObject.SetActive(false);
        TapToPlane.SetActive(false);
    }
    
    public void ShowTapToPlace()
    {
        HideAllAnimation();
        TapToPlane.SetActive(true);
        currentAnimation = TapToPlane;
    ...
    {
        HideAllAnimation();
        FindBody.SetActive(true);
        currentAnimation = FindBody;
    ...
    {
        HideAllAnimation();
        FindFace.SetActive(true);
        currentAnimation = FindFace;
    ...
    public void FadeOffCurrentUI()
    {
        ...
        if (currentAnimation != null) //if (m_VideoPlayer.clip != null)
        {
